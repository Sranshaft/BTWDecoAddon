...
public class DecoBlockCarpetWool extends Block 
{
	private Icon[] m_IconByMetadataArray = new Icon[16];

	public DecoBlockCarpetWool(int id) 
	{
		...
		DecoAddonManager.register(this, DecoUtilsStrings.COLOUR_TAGS, DecoUtilsStrings.COLOUR_NAMES, " Wool Carpet");
	}
	...
	public void registerIcons(IconRegister register) 
	{
		...
		{
			this.m_IconByMetadataArray[index] = register.registerIcon("decoBlockWoolCarpet_" + DecoUtilsStrings.COLOUR_TAGS[index]);
		}
	}
