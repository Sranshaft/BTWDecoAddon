...
public class DecoUtilsStrings 
{
	...
	public static final String[] DIRT_TAGS = new String[] { "normal", "coarse", "dried", "rich" };
	public static final String[] DIRT_NAMES = new String[] { "", "Coarse", "Dried", "Rich" };
	...
	public static final String[] STORAGE_CONGEALED_TAGS = new String[] { "creeperOyster", "glue", "magmaCream", "netherSludge", "slime", "spiderEye", "tallow", "venomSac" };
	public static final String[] STORAGE_CONGEALED_NAMES = new String[] { "Creeper Oyster", "Glue", "Magma Cream", "Nether Sludge", "Slime", "Spider Eye", "Tallow", "Venom Sac" };
	...
	public static final String[] TREE_TOP_TEXTURE_PATHS = new String[] {"tree_top", "tree_top_spruce", "tree_top_birch", "tree_top_jungle", "tree_top_ebonwood", "tree_top_ironwood" };
