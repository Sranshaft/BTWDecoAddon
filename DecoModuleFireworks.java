...
public class DecoModuleFireworks {
	
	public DecoModuleFireworks()
	{
		FCAddOnHandler.LogMessage("[INFO]: Loading module: Fireworks");
	...
	private class RecipeFireworks_Color implements IRecipe
	{
