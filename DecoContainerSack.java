...
public class DecoContainerSack extends Container implements DecoIContainer
{
	private final DecoTileEntitySack m_LocalTileEntitySack;
	private final int m_NumSlots = 9;
	private int m_NumRows;
	
	public DecoContainerSack(IInventory inventory, DecoTileEntitySack entity)
	{
	    this.m_LocalTileEntitySack = entity;
	...
	{
	    return this.m_LocalTileEntitySack.isUseableByPlayer(player);
	}
