...
public class DecoSubModuleExtendedStoneBlock implements DecoISubModule
{
	...
	public DecoSubModuleExtendedStoneBlock()
	{
		FCAddOnHandler.LogMessage("[INFO]: Loading submodule: Extended Stone Blocks");
		
		//this.decoBlockStoneBrick = new DecoBlockStoneBrick(DecoAddonManager.replaceBlockID(Block.stoneBrick), "stonebricksmooth", "Stone Brick", Block.stoneBrick.blockHardness, Block.stoneBrick.blockResistance);
		this.decoBlockWallCobblestone = new DecoBlockWall(DecoAddonManager.replaceBlockID(Block.cobblestoneWall), Block.cobblestone, new String[] { "cobblestone", "mossyCobblestone" }, new String[] { "Cobblestone", "Mossy Cobblestone" }, new String[] { "stonebrick", "stoneMoss" });
