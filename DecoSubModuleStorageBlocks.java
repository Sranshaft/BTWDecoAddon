...
public class DecoSubModuleStorageBlocks implements DecoISubModule
{
	...
	public DecoSubModuleStorageBlocks()
	{
		FCAddOnHandler.LogMessage("[INFO]: Loading submodule: Storage");
	...
	public void addRecipes() 
	{
		...
		DecoUtilsRecipes.addStorageRecipe(DecoModuleTweaks.decoItemFertilizer, new ItemStack(this.decoBlockStoragePowder, 1, 5));
	...
	{
		this.decoBlockBone.SetPicksEffectiveOn();
		this.decoBlockStorage.SetPicksEffectiveOn();
		this.decoBlockStorageCongealed.SetShovelsEffectiveOn();
		this.decoBlockStoragePowder.SetShovelsEffectiveOn();
	}
