...
public class DecoBlockCabinet extends Block implements FCIBlock, FCIBlockSolidTop
{
	...
	public DecoBlockCabinet(int id, String tag)
	{
		...
		setUnlocalizedName("decoBlockCabinet." + tag);
		setHardness(2.0F);
		setResistance(5.0F);
	...
	public void setBlockBoundsBasedOnState(IBlockAccess bAccess, int x, int y, int z)
	{
		...
		setBlockBounds(rotatedMinX, 0.0F, rotatedMinZ, rotatedMaxX, 1.0F, rotatedMaxZ);
	}
