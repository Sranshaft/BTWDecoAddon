...
public class GuiIngame extends Gui
{
    ...
    {
        FontRenderer var1 = this.mc.fontRenderer;
        int var2 = MathHelper.floor_double(this.mc.thePlayer.posX) % 16;
        ...
        int var4 = MathHelper.floor_double(this.mc.thePlayer.posZ) % 16;
        ...
        this.drawString(var1, String.format("Dist To Chnk Bndry: %d", new Object[] {Integer.valueOf(var6)}), 2, 64, 14737632);
    }

    private void renderEnderSpectaclesBlur(int var1, int var2)
    {
        GL11.glDisable(GL11.GL_DEPTH_TEST);
        GL11.glDepthMask(false);
        GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
    ...
    private void RenderModSpecificPlayerSightEffects()
    {
        ...
        ItemStack var4 = this.mc.thePlayer.inventory.armorItemInSlot(3);

        if (this.mc.gameSettings.thirdPersonView == 0 && var4 != null && var4.itemID == FCBetterThanWolves.fcItemEnderSpectacles.itemID)
        {
            this.renderEnderSpectaclesBlur(var2, var3);
            this.AddTrueSightParticles();
        }
        else if (this.mc.gameSettings.thirdPersonView == 0 && this.mc.thePlayer.isPotionActive(FCBetterThanWolves.potionTrueSight))
        {
            this.AddTrueSightParticles();
        }
    }
    ...
    private void AddTrueSightParticles()
    {
        ...
        if (!this.mc.isGamePaused && (var2.provider.dimensionId == 0 || var2.provider.dimensionId == 1))
        {
            ...
            for (int var7 = var4 - 10; var7 <= var4 + 10; ++var7)
            {
                for (int var8 = var5 - 10; var8 <= var5 + 10; ++var8)
                {
                    ...
                    {
                        if (FCUtilsWorld.CanMobsSpawnHere(var2, var7, var8, var9) && (var3 == 0 || this.rand.nextInt(12) <= 2 - var3 << 1))
                        {
                            double var10 = (double)var7 + this.rand.nextDouble();
                            double var12 = (double)var8 + this.rand.nextDouble() * 0.25D;
                            double var14 = (double)var9 + this.rand.nextDouble();
                            this.SpawnTrueSightParticle(var2, var10, var12, var14);
                        }
                    }
                }
            }
