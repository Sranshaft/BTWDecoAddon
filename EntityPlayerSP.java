...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    public static boolean startSlowdown = false;
    public static double zoomProgress = 1.0D;
    public static double prevZoomProgress = 1.0D;
    ...
    public float getFOVMultiplier()
    {
        ...
        if (this.isUsingItem() && (this.getItemInUse().itemID == Item.bow.itemID || this.getItemInUse().itemID == FCBetterThanWolves.fcCompositeBow.itemID))
        {
