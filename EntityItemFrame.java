...
public class EntityItemFrame extends EntityHanging
{
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        {
        	if (this.getDisplayedItem() != null && !this.worldObj.isRemote)
        	{
        		ItemStack var1 = this.getDisplayedItem();
        		this.entityDropItem(var1, 1.0F);
        		
        		this.worldObj.spawnEntityInWorld(new EntityItemFrame(this.worldObj, this.xPosition, this.yPosition, this.zPosition, this.hangingDirection));
        		this.setDead();
        	}
